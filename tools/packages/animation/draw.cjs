if(katexLoaded,
  ...
  if(showDebugInfo,
      ...
      if(numberOfTracks > 0, drawtext(debugInfoPosition + [0, -1.5], "Track progress: " + format(parse("t" + min(numberOfTracks, currentTrackIndex)), 2), size -> 25, color -> debugInfoColor));
